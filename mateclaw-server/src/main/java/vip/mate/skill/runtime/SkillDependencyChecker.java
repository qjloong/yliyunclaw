...
public class SkillDependencyChecker {
    ...
    private boolean isCommandAvailable(String command) {
        for (String candidate : candidateCommands(command)) {
            if (isSingleCommandAvailable(candidate)) {
                return true;
            }
        }
        return false;
    ...
    private boolean isSingleCommandAvailable(String command) {
        try {
    ...
    private List<String> candidateCommands(String command) {
        ...
        if (isWindows()) {
            if ("python3".equals(normalized)) {
                return List.of("python3", "python", "py");
            }
            if ("python".equals(normalized)) {
                return List.of("python", "py", "python3");
            }
        } else {
            if ("python".equals(normalized)) {
                return List.of("python", "python3");
            }
            if ("python3".equals(normalized)) {
