export default {
  ...
  chat: {
    ...
    compressionTokens: 'Token reduction',
    compressionMessages: 'Messages summarized',
    compressionTailKept: 'Tail kept',
    compressionToolSpills: 'Spilled tool results',
    compressionAnchored: 'First user goal anchored',
    compressionTrigger: 'Trigger',
    compressionSummaryId: 'Summary ID',
    compressionTriggerTokenThreshold: 'Context threshold reached',
    ...
    streamStarted: 'Connected, preparing the run...',
    streamContextPrepared: 'Context ready, packaging the request...',
    streamLlmRequestSent: 'Request sent to the model, waiting for the first response...',
    ...
    compactPairSafe: 'Adjusting the boundary to preserve tool-call pairs...',
    compactSummarize: 'Summarizing older turns...',
    compactStartWithTokens: 'Compacting context... ({tokens})',
    compactSummarizeWithCount: 'Summarizing older turns... ({count} msgs)',
    compactDone: 'Context compaction complete',
    compactDoneWithTokens: 'Context compacted ({before} → {after})',
    compactSkipped: 'No compaction needed this turn',
    compactSkippedInsufficient: 'Skipped compaction because there were too few messages',
    compactSkippedPairBoundary: 'Skipped compaction to avoid splitting tool-call pairs',
    compactFailed: 'Summary generation failed; fell back to a safe mode',
