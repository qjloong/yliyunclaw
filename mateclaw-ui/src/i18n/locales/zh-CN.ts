export default {
  ...
  chat: {
    ...
    compressionTokens: '压缩前后 Token',
    compressionMessages: '摘要消息数',
    compressionTailKept: '保留尾部消息',
    compressionToolSpills: '溢出工具结果',
    compressionAnchored: '保留首个用户目标',
    compressionTrigger: '触发原因',
    compressionSummaryId: '摘要 ID',
    compressionTriggerTokenThreshold: '达到上下文阈值',
    ...
    preparingDefaultAgent: '正在准备默认助手...',
    defaultAgentName: '默认助手',
    defaultAgentSuffix: '助手',
    defaultAgentDescription: '自动创建的工作区默认助手，可直接开始对话与代码协作。',
    defaultAgentCreateFailed: '默认助手创建失败，请稍后重试',
    noConversations: '暂无会话',
    noConversationsInWorkspace: '当前 Workspace（{workspace}）下还没有会话',
    startNewChat: '开始新对话吧',
    noAgentsInWorkspace: '当前 Workspace 下还没有可选 Agent',
    entryTitle: '从这里开始一段新对话',
    entrySubtitle: '选择一个 Agent 后即可开始当前工作区中的新对话。',
    entryPrimaryStart: '使用 {agent} 开始',
    entryManageAgents: '管理 Agent',
    entryRecentTitle: '继续最近会话',
    entryRecentMeta: '{time} · {count} 条消息',
    entryAgentsTitle: '选择一个 Agent',
    entryAgentsHint: '点击任意 Agent 后，将在当前工作区中开始一个新的空白对话。',
    entryTemplatesTitle: '或从官方 Starter 快速创建',
    entryTemplatesHint: '如果你还没决定用哪个 Agent，可以先直接创建一个官方默认模板并立刻开聊。',
    entryTemplateAction: '创建并使用',
    entryTemplateCreating: '正在创建...',
    entryTemplateCreateFailed: 'Starter 创建失败，请稍后重试',
    messages: '{count} 条消息',
    workingDirectory: '工作目录',
    workingDirectoryHint: '为空时继承当前工作区活动目录',
    workingDirectorySaved: '工作目录已更新',
    workingDirectorySaveFailed: '工作目录更新失败',
    workingDirectoryPending: '将在首条消息发送时应用该目录',
    workingDirectoryWorkspaceRequired: '当前工作区未配置活动目录',
    projectUnsetLabel: '设置 Project',
    projectSelectorTitle: 'Project 选择器',
    projectSelectorBrowse: '浏览文件夹',
    projectSelectorCurrent: '当前浏览目录',
    projectSelectorUseCurrent: '使用当前目录',
    projectSelectorGoRoot: '回到根目录',
    projectSelectorGoUp: '上一级',
    projectSelectorEmpty: '当前目录下没有可继续进入的子文件夹',
    projectSelectorLoading: '正在加载目录...',
    projectSelectorSwitchWarningTitle: '切换当前 Project？',
    projectSelectorSwitchWarning: '这个会话已经围绕当前 Project 进行了对话。继续切换目录可能让后续上下文与记忆混在一起，建议新建一个会话再切换 Project。',
    projectSelectorSwitchConfirm: '仍然切换',
    projectSelectorSwitchNewConversation: '新建会话并切换',
    runtimeMode: '工作模式',
    runtimeModeHint: '默认模式跟随 Agent 类型，Plan 模式会强制启用计划执行',
    runtimeModeDefault: '默认',
    runtimeModePlan: 'Plan',
    runtimeModeCoding: 'Coding',
    runtimeModeCodingUnavailable: '当前智能体未启用 Coding 工作流，请切换到编码模板智能体后再试',
    runtimeModeSaved: '工作模式已更新',
    runtimeModeSaveFailed: '工作模式更新失败',
    runtimeModePending: '将在首条消息发送时应用该工作模式',
    teacherBuilder: {
      kicker: '教学任务单',
      title: '名师出题助手快捷生成器',
      hint: '将常用出题要素整理成结构化请求，一键填入输入框或直接发送。',
      boundKnowledgeBases: '当前 Agent 已绑定 {count} 个知识库。',
      collapse: '收起',
      expand: '展开',
      reset: '恢复默认',
      fillInput: '填入输入框',
      ...
      fields: {
        ...
        difficulty: '难度',
        includeAnswers: '生成答案',
        includeScoringRubric: '生成采分点',
        imitateSampleStyle: '模仿范题风格',
        customRequirement: '补充要求',
      },
      placeholders: {
        book: '例如：西游记、朝花夕拾',
        customRequirement: '例如：贴近本校月考风格，控制主观题字数，优先覆盖本周复习章节。',
      },
    },
    teacherGuide: {
      kicker: '出题规范已启用',
      title: '直接说需求即可',
      summaryBound: '直接描述班级、名著、题量或风格要求即可；系统会自动按当前绑定的 {count} 个知识库与会话材料做来源约束、答案采分点和质量审核。',
      summaryUnbound: '直接描述出题需求即可；若当前没有绑定知识库，系统会先判断材料是否足够，不足时提示补充，避免凭空编造。',
      compactBound: '已按当前绑定的 {count} 个知识库启用来源约束、采分点和质量审核。',
      compactUnbound: '当前会按会话材料做来源校验，材料不足时会提示补充。',
      quickStart: '常用起手式',
      showRules: '查看详情',
      hideRules: '收起详情',
      showBanner: '显示规范提示',
      hideBanner: '暂时隐藏规范提示',
      rulesTitle: '当前默认约束',
      quickPromptFallback: '示例 {index}',
      fallbackRules: {
        sourceGrounding: '材料、片段、人物关系与情节细节必须来自当前知识库或会话材料。',
        planFirst: '先规划每道题的考点、题型、难度和分值，再输出完整试题。',
        answerRubric: '主观题默认提供参考答案与可直接判分的采分点。',
        reviewRequired: '结尾必须补充来源、重复、难度梯度和采分可操作性的质量审核。',
      },
      defaultPrompts: {
        classroomLabel: '课堂练习',
        classroomPrompt: '请围绕当前材料生成一组课堂练习题，先给出命题规划，再输出试题、答案和采分点。',
        examLabel: '单元检测',
        examPrompt: '请按单元检测的形式出一组题，要求覆盖不同难度层次，并在结尾补充质量审核。',
        styleLabel: '范题仿写',
        stylePrompt: '如果我上传范题，请先总结命题规律，再基于当前材料仿写同风格题目。',
      },
    },
    agentStarterTemplate: '官方预设',
    currentProject: '当前 Project',
    workspaceRoot: '工作区根目录',
    projectPermissionMode: 'Project 权限',
    projectPermissionLimited: '有限权限（需审批）',
    projectPermissionFull: '完全权限（直接执行）',
    configModel: '配置模型',
    clearMessages: '清空消息',
    ...
    runtimeModelFallbackNotice: '当前会话配置的模型 {from} 已不可用，已自动回退到 {to}。',
    runtimeModelFallbackCleared: '当前会话配置的模型 {from} 已不可用，且没有找到可回退的可用模型。已改为跟随系统默认模型。',
    imageVisionUnsupported: '当前模型 {model} 不支持图片理解。图片会保留为附件路径文本，但不会按多模态图片发送。若要直接识图，请切换到视觉模型。',
    ...
    emptyAssistantResult: '本次生成已结束，但没有返回可展示的正文内容。请重试，或换一种更明确的出题要求。',
    viewResult: '查看结果',
    ...
    approvalSummaryLabel: '原因：',
    approvalBoundaryLabel: '边界：',
    approvalRecoveryLabel: '恢复建议：',
    approvalAllowedPathsLabel: '允许路径',
    approvalDeniedPathsLabel: '拒绝路径',
    approvalAttemptedPathLabel: '目标路径',
    approvalWorkspaceRootLabel: '工作区根目录',
    reviewTitle: 'Review',
    reviewChangedFilesCount: '{count} 个文件',
    reviewChangedFiles: '本轮改动文件',
    reviewProjectFiles: '当前 Project 已追踪文件',
    reviewItemsCount: '{count} 项',
    reviewValidationTitle: '本轮校验结果',
    reviewValidationPassed: '已通过',
    reviewValidationFailed: '失败',
    reviewValidationRunning: '执行中',
    reviewValidationPending: '待审批',
    reviewValidationApproved: '已批准',
    reviewValidationDenied: '已拒绝',
    reviewValidationCompleted: '已完成',
    projectChangesTitle: 'Project Changes',
    projectCacheTitle: '项目理解缓存',
    projectCacheEmpty: '当前 Project 还没有缓存摘要。',
    projectCacheProjectRoot: '定位到的项目根目录',
    projectCacheWorkingDirectory: '当前工作目录',
    projectCacheLocator: '定位依据',
    projectCacheGitRoot: 'Git 根目录',
    projectCacheStacks: '技术栈',
    projectCacheFiles: '关键文件',
    projectCacheModules: '主要目录',
    projectCacheMaterials: '资料索引',
    projectCacheCommands: '常用命令',
    projectCacheRunLocal: '本地验证',
    projectCacheApproveLocal: '批准并执行',
    projectCacheDenyLocal: '取消',
    projectCacheValidationPending: '本地验证待确认',
    projectCacheValidationRunning: '本地验证执行中',
    projectCachePackageManager: '包管理器',
    projectCacheBuildSystem: '构建系统',
    desktopValidationProjectMissing: '当前没有可用的本地项目根目录。',
    desktopValidationUnsupported: '该命令当前不在允许的本地验证白名单内。',
    desktopValidationApproveFailed: '本地验证审批失败。',
    desktopValidationDenyFailed: '本地验证审批取消失败。',
    desktopValidationExecuteFailed: '本地验证执行失败。',
    contextRouterTitle: '上下文路由',
    contextRouterEmpty: '当前智能体还没有可展示的上下文路由摘要。',
    contextRouterSources: '启用来源',
    contextRouterFlags: '模板开关',
    contextRouterProjectDerived: '项目派生上下文',
    contextRouterSessionTemporary: '会话临时上下文',
    contextRouterKnowledgeKeys: '建议知识来源',
    contextRouterMissingBindings: '缺失知识绑定',
    contextRouterMemory: '工作区记忆文件',
    contextRouterWiki: '知识库路由',
    contextRouterSessions: '近期会话',
    contextRouterUnbound: '未绑定知识库',
    contextRouterSourceProject: '项目缓存',
    contextRouterSourceMemory: '工作区记忆',
    contextRouterSourceWiki: '知识库',
    contextRouterSourceSession: '会话检索',
    ...
    executionToolsTitle: '工具活动',
    executionApprovalsTitle: '审批记录',
    executionTestsTitle: '命令与测试',
    executionEmpty: '暂时没有可展示的执行数据。',
    executionAgent: '智能体',
    executionRuntime: '运行时',
    executionTokens: 'Token',
    executionDuration: '耗时',
    executionError: '错误',
    executionPlanning: '规划',
    executionPlanStep: '计划步骤',
    executionLifecycle: '生命周期',
    executionStep: '执行步骤',
    executionStatusCompleted: '已完成',
    executionStatusFailed: '失败',
    executionStatusInterrupted: '已中断',
    executionStatusRunning: '进行中',
    executionApprovalPending: '待审批',
    executionApprovalUnknown: '审批项',
    executionTestResult: '测试结果',
    executionCommandResult: '命令结果',
    executionDetailsTitle: '执行详情',
    reviewCheckpointTitle: 'Checkpoint',
    reviewCheckpointSupported: '支持恢复',
    reviewCheckpointUnavailable: '暂不支持恢复',
    reviewAdded: '新增',
    reviewModified: '修改',
    reviewDeleted: '删除',
    reviewRenamed: '重命名',
    reviewUntracked: '未跟踪',
    reviewBytesWritten: '{count} 字节',
    reviewReplacements: '{count} 处替换',
    pendingApprovalPlaceholder: '输入 /approve 或 /deny 来回复...',
    messagePlaceholder: '输入消息... (Enter 发送, Shift+Enter 换行)',
    inaccessibleConversation: '当前会话已无访问权限，已自动重置。',
    deletedAgentReadonlyTitle: '当前会话为只读',
    deletedAgentReadonlyHint: '该会话绑定的智能体已删除，当前仅支持只读查看。',
    mockTask: {
      kicker: '内置样例任务',
      expectedCount: '{count} 个验收点',
      evidence: '运行证据：{status}，步骤 {steps}，工具 {tools}，审批 {approvals}，命中 {matched}/{total}',
      runEvidenceLabel: '本次运行摘要',
      score: '自动评分 {score} / 100（{confidence} 置信度）',
      showDetails: '展开详情',
      hideDetails: '收起详情',
      compactSummaryChecks: '已命中 {matched}/{total} 个验收点',
      compactSummaryBlocked: '存在 {blocked} 个阻塞项，已命中 {matched}/{total} 个验收点',
      compactSummaryReady: '展开后可查看完整验收过程',
      previewLabel: '最终回答预览',
      signalLabel: '自动评分信号',
      gateBlockersLabel: '验收阻塞项',
      structuredEvidenceLabel: '结构化证据',
      validationCommandsLabel: '验证命令',
      validationResultsLabel: '验证结果',
      diffLabel: '补丁证据',
      diffSummary: '文件 {files}，区块 {hunks}，+{added} / -{removed}',
      sourcesLabel: '来源轨迹',
    ...
    shortcuts: {
      ...
      modeUsageNoCoding: '用法：/mode default 或 /mode plan',
      projectToast: '当前 Project：{workspace} / {project}',
      permissionToast: '当前权限：{mode}',
      modeDefaultLabel: '切换到默认模式',
      modeDefaultDescription: '沿用 Agent 原始运行方式',
      modePlanLabel: '切换到 Plan 模式',
      modePlanDescription: '强制使用计划执行模式',
      modeCodingLabel: '切换到 Coding 模式',
      modeCodingDescription: '按探索、计划、修改、测试、总结的编码流程执行',
      cwdLabel: '切换工作目录',
      cwdDescription: '输入 /cwd <路径> 以切换当前 Project',
      projectLabel: '查看当前 Project',
      projectDescription: '显示当前 workspace 与 project 上下文',
      permissionLabel: '查看当前权限模式',
      permissionDescription: '显示当前 project 权限与审批状态',
    ...
    composer: {
      ...
      defaultPermissionsHint: '工作区内常规读写默认允许；敏感路径和高风险命令仍可能触发审批或拦截。',
      fullAccess: '完全访问',
      fullAccessHint: '自动放行原本需要审批的受控操作；仍受工作区边界和硬阻断规则限制。',
      permissionBoundaryHint: '权限模式只影响审批行为，不会绕过工作区边界或绝对阻断。',
      permissionSaved: 'Project 权限已更新',
      permissionSaveFailed: 'Project 权限更新失败',
      workspaceEntryLabel: 'Workspace',
      workspaceEntryMeta: '当前空间',
      workspacePopoverTitle: '切换 Workspace',
      workspacePopoverHint: '这里用于切换现有 Workspace，或直接从本地文件夹新建一个 Workspace。',
      pickWorkspaceFolder: '选择本地文件夹并新建 Workspace',
      workspaceFolderClientOnly: '仅桌面客户端可直接选择本地文件夹。浏览器环境下无法安全获取可绑定的本地绝对路径。',
      workspaceFolderUnsupported: '当前环境不支持直接选择本地文件夹。请在桌面客户端使用，或前往工作空间设置手动创建。',
      workspaceCreatedAndSwitched: '已切换到 Workspace：{name}',
      workspaceCreateFailed: '创建 Workspace 失败',
      projectEntryLabel: 'Project',
      projectBoundMeta: '已绑定',
      projectUnsetMeta: '未绑定',
      projectPopoverTitle: '绑定 Project 文件夹',
      projectPopoverHint: '点击下方目录即可绑定当前会话的 Project；也可以手动输入工作目录后保存。',
      workspaceSection: '工作空间',
      workspaceListEmpty: '暂时没有已绑定本地目录的工作区',
      workspaceSettings: '工作空间设置',
      workspaceSwitched: '工作空间已切换',
      workspaceSwitchFailed: '工作空间切换失败',
    },
    thinkingOn: '深度思考已开启，回答会更稳但更慢',
    thinkingOff: '点击开启深度思考，普通问答默认关闭以提升速度',
    ...
    streamQueued: '排队中...',
    streamConnecting: '正在建立连接...',
    streamStarted: '连接已建立，准备开始...',
    streamContextPrepared: '上下文已准备，正在整理请求...',
    streamLlmRequestSent: '请求已发送给模型，等待首个响应...',
    streamReconnecting: '重新连接...',
    streamStopped: '已停止',
    streamCompleted: '已完成',
    streamElapsedSuffix: '（已等待 {sec}s）',
    compactStart: '正在压缩上下文...',
    compactPairSafe: '正在调整边界以保留工具配对...',
    compactSummarize: '正在生成压缩摘要...',
    compactStartWithTokens: '正在压缩上下文...（{tokens}）',
    compactSummarizeWithCount: '正在生成压缩摘要...（{count} 条消息）',
    compactDone: '上下文压缩完成',
    compactDoneWithTokens: '上下文压缩完成（{before} → {after}）',
    compactSkipped: '本轮无需压缩上下文',
    compactSkippedInsufficient: '消息较少，跳过上下文压缩',
    compactSkippedPairBoundary: '为避免拆分工具配对，跳过上下文压缩',
    compactFailed: '压缩摘要生成失败，已回退到安全模式',
    ...
    approvalAllow: '允许',
    approvalExecute: '执行？',
    approvalRemember: '记住为',
    approvalScopeOnce: '仅这次',
    approvalScopeConversation: '本次对话中的同类操作',
    approvalScopeProject: '当前 Project 中的同类操作',
    // 时间格式
    timeJustNow: '刚刚',
  ...
  nav: {
    ...
    downloadClientHint: '本地文件夹、项目操作和高级能力',
    workspaceEntryLabel: '工作空间',
  },
  settings: {
    title: '设置',
    kicker: '配置中心',
    ...
    model: {
      ...
      addModel: '新增模型',
      modelTypeChat: '聊天模型',
      modelTypeEmbedding: 'Embedding 模型',
      embeddingModalHint: 'Embedding 模型添加后，会出现在下方的 Embedding 模型区域中；聊天模型列表不会显示它。',
  ...
  agents: {
    ...
    templates: {
      ...
      featured: '默认',
      healthReady: '知识就绪 {matched}/{total}',
      healthNeedsSetup: '需初始化知识 {matched}/{total}',
      healthUnknown: '知识状态未知',
      defaultKnowledge: '默认知识库 {matched}/{total}',
      caseChecks: '模板完整度 {matched}/{total}',
      applicationReady: '已创建 Agent 文件 {matched}/{total}',
      applicationNeedsSetup: '已创建 Agent 文件 {matched}/{total}，建议同步默认文件',
      applicationMissing: '尚未创建样板 Agent',
      syncDefaultFiles: '同步默认文件',
      startMockTask: '运行样例任务',
      syncSuccess: '默认文件已同步，补齐 {count} 个文件',
      syncNoop: '默认文件已是最新，无需同步',
      syncFailed: '同步默认文件失败',
    },
    search: '搜索智能体...',
    tabs: {
    ...
    home: {
      hint: '配置这个智能体的空会话首页。留空时，系统会根据智能体描述和提示词自动生成上手入口。',
      subtitle: '首页副标题',
      subtitlePlaceholder: '显示在聊天首页标题下方',
      subtitleHint: '留空时优先使用智能体描述，再使用默认助手副标题。',
      quickStartIndex: '快捷入口 {index}',
      quickStartTitle: '展示标题',
      quickStartTitlePlaceholder: '例如：了解这个智能体能做什么',
      quickStartPrompt: '点击后发送的提示词',
      quickStartPromptPlaceholder: '用户点击该入口后，真正发送给智能体的消息',
      clear: '清空',
      clearAll: '清空首页配置',
    },
    fields: {
    ...
    messages: {
      ...
      saveFailed: '保存智能体失败',
      saveSuccess: '智能体已保存',
      defaultSet: '已将「{name}」设为当前工作区默认智能体',
      deleteFailed: '删除智能体失败',
      deleteSuccess: '智能体已删除',
      restoreFailed: '恢复智能体失败',
      restoreSuccess: '智能体已恢复',
      toggleFailed: '切换状态失败',
      toggleSuccess: '状态已更新',
    },
    binding: {
      ...
      knowledgeHint: '可选。勾选后，该智能体会在会话中优先使用这些知识库；不勾选则不自动注入知识库上下文。',
      knowledgePlaceholder: '搜索并选择知识库',
      noKnowledgeBaseMatch: '未找到匹配的知识库',
      noSkills: '暂无可用技能',
      noTools: '暂无可用工具',
      noKnowledgeBases: '当前工作区暂无知识库',
  ...
  security: {
    ...
    members: {
      ...
      invites: {
        title: '邀请链接',
        desc: '生成一个一次性工作区邀请链接。受邀人必须先登录，才能加入当前工作区。',
        generate: '生成邀请链接',
        generating: '生成中...',
        copy: '复制链接',
        expiresAt: '有效期至：{date}',
        activeTitle: '邀请记录',
        activeDesc: '查看已生成邀请的使用次数、有效期和状态，不再使用的链接可以随时撤销。',
        empty: '暂无邀请记录。',
        revoke: '撤销',
        columns: {
          role: '角色',
      ...
      messages: {
        ...
        inviteCreateFailed: '生成邀请链接失败',
        inviteLoadFailed: '加载邀请记录失败',
        inviteCopied: '邀请链接已复制',
        inviteCopyFailed: '复制邀请链接失败',
        inviteRevokeConfirm: '确定撤销这个邀请链接吗？撤销后，收到链接的人将无法再使用它加入工作区。',
        inviteRevoked: '邀请链接已撤销',
        inviteRevokeFailed: '撤销邀请链接失败',
  ...
  workspaceInvite: {
    title: '加入工作区',
    loading: '正在加载邀请信息...',
    invalid: '该邀请无效、已过期，或你当前没有权限访问。',
    invitedBy: '邀请人：{username}',
    role: '加入后角色：{role}',
    expiresAt: '过期时间：{date}',
    accept: '接受邀请并进入工作区',
    accepting: '加入中...',
    acceptSuccess: '已加入工作区',
    acceptFailed: '接受邀请失败',
    backToChat: '返回对话',
    alreadyMember: '你已经在这个工作区中，正在为你打开工作区。',
  },
    workspaces: {
      title: '工作区管理',
      desc: '管理组织的工作区。',
      ...
      createDialog: {
        ...
        projectPermissionMode: 'Project 权限模式',
        projectPermissionModeHint: '有限权限下风险操作需审批；完全权限下可直接执行受控操作。',
        policyGuidanceTitle: '访问策略生效顺序',
        policyGuidanceBoundary: '工作区活动目录始终是最外层边界，完全权限也不会绕过它。',
        policyGuidancePolicy: 'allowedPaths 与 deniedPaths 会进一步收紧范围；命中拒绝路径或只读沙箱时会直接拦截工具执行。',
        policyGuidanceRecovery: '如果工具被拦截，应先把目标路径移回工作区范围或调整工作区策略，而不是盲目重试。',
        sandboxMode: '沙箱模式',
        approvalPolicy: '审批策略',
        networkPolicy: '网络策略',
        allowedPaths: '允许路径',
        allowedPathsPlaceholder: '每行一个路径，可写相对路径，例如：\nsrc\ndocs',
        allowedPathsHint: '非空时，仅允许访问这些子路径；相对路径会基于活动目录解析。',
        deniedPaths: '拒绝路径',
        deniedPathsPlaceholder: '每行一个路径，例如：\n.git\nsecrets',
        deniedPathsHint: '命中这些路径会被工作区策略拦截。',
        riskOverrides: '风险覆盖',
        riskOverridesPlaceholder: '示例：\nwrite_file = approve\nexecute_shell_command = block',
        riskOverridesHint: 'JSON 对象：value 支持 allow / approve / block / low / medium / high / critical。',
      },
      quickCreate: {
        entry: '快速创建工作空间',
        title: '快速创建工作空间',
        subtitle: 'Web 端可直接创建并切换工作空间，本地文件夹绑定不是必填项。',
        name: '名称',
        namePlaceholder: '例如：工程团队',
        slug: '标识',
        slugPlaceholder: '留空时将根据名称自动生成',
        description: '描述',
        descriptionPlaceholder: '可选描述',
        basePath: '活动目录',
        basePathPlaceholder: '可选：/home/user/project 或 D:\\codes\\MyProject',
        basePathHint: '留空即可创建纯 Web 工作空间，后续需要时再绑定本地目录。',
        createSuccess: '已创建并切换到工作空间：{name}',
        createFailed: '创建工作空间失败',
        noPermission: '没有权限创建工作空间，请联系管理员。',
      },
      editDialog: {
        title: '编辑工作区',
      },
      ...
      messages: {
        ...
        invalidRiskOverrides: '风险覆盖必须是合法的 JSON 对象',
      },
    },
    toolGuard: {
      title: '工具防护',
  ...
  wiki: {
    ...
    extractionHints: {
      text: '文本材料直接入库，无需额外解析器。',
      pdf: 'PDF 自动提取链：pdftotext → Python(pdfplumber/pypdf) → PDFBox → OCR → Tika；重新处理会清理旧缓存后重新提取。',
      docx: 'Word 自动提取链：系统命令/ZIP XML → Tika 兜底；重新处理会清理旧缓存后重新提取。',
    },
    saving: '保存中...',
    status: {
      active: '启用',
  ...
  cronJobs: {
    ...
    fields: {
      ...
      taskType: '任务类型',
      workingDirectory: '工作目录',
      workingDirectoryPlaceholder: '留空表示使用工作区根目录，也可填写相对路径或绝对路径',
      workingDirectoryHint: '目录会绑定到该定时任务的执行上下文，且必须位于 Agent 所属工作区活动目录内。',
      triggerMessage: '触发消息',
  ...
  desktopServer: {
    title: '桌面端服务器配置',
    description: '桌面应用会先加载本地页面，再通过本地代理把 /api 请求转发到你配置的后端地址。打包版默认连接官方云端，你也可以切换到本地或其他节点进行调试。',
    desktopOnly: '该页面仅在桌面客户端中生效。',
    currentBackend: '当前后端地址',
    configureEntry: '配置服务器地址',
    backendUrlLabel: '后端地址',
    backendUrlPlaceholder: '例如 https://claw-demo.mate.vip、http://127.0.0.1:18088 或 https://your-server.example.com',
    autoStart: '启动桌面端时自动拉起本地后端命令',
    backendCommandLabel: '后端启动命令',
    backendArgsLabel: '启动参数',
    backendArgsPlaceholder: '例如 java -jar mateclaw-server.jar 的附加参数',
    backendCwdLabel: '命令执行目录',
    testConnection: '测试连接',
    testSuccess: '连接测试成功',
    testFailed: '连接测试失败',
    saveSuccess: '桌面服务器配置已保存',
    saveFailed: '保存桌面服务器配置失败',
  },
  desktopProxy: {
    title: '桌面端代理地址配置',
    description: '桌面应用会先打开打包后的本地静态 UI，再通过本地代理把 /api 请求转发到默认后端；如果这里配置了代理地址，请求将优先转发到代理地址。',
    currentBackend: '当前后端地址',
    currentTarget: '当前实际转发目标',
    backendHint: '这里决定桌面端最终连接的后端地址；保存后新的登录与 API 请求会立即走新的目标。',
    proxyUrlLabel: '代理地址',
    proxyUrlPlaceholder: '例如 http://127.0.0.1:10808 或 https://your-proxy.example.com',
    proxyHint: '留空表示不走代理，直接转发到默认后端地址。保存后立即生效。',
    clearAction: '清空代理',
    saveSuccess: '代理地址已保存',
    saveFailed: '保存代理地址失败',
  },
  channels: {
    ...
    webchatHint: 'WebChat 用于把 Meta Y 聊天挂件嵌入外部网站。请配置 API Key、标题和主题色，然后在网站中引入 WebChat SDK。',
